...
where s.mat=st.mat and st.idsujet=sg.idsujet and sg.numconv=pf.numconv and pf.codepfe=sn.codepfe and sn.codest = p.codest  AND PROMO='2018' and djury='admis'");
$a1=$rq->fetchColumn();
...
from stagiaire s, sujet st, stage sg, pfe pf,soutenance sn, pv p
where s.mat=st.mat and st.idsujet=sg.idsujet and sg.numconv=pf.numconv and pf.codepfe=sn.codepfe and sn.codest = p.codest  AND PROMO='2018' and djury='ajourne'");
$a2=$rq2->fetchColumn();
...
$b1plot->SetWidth(50);
$graph->title->Set("Stagiaires d'admis et ajournés de la promotion 2018");
